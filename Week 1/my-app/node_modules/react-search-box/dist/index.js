...
var StyledInput = styled.input.withConfig({
  ...
  componentId: "hakmvc-1"
})(["font-size:16px;padding:10px 20px;height:50px;width:500px;border:1px solid #cacaca96;&:focus{outline:none;}"]);
var StyledDropdown = styled.div.withConfig({
  displayName: "src__StyledDropdown",
  componentId: "hakmvc-2"
})(["margin:10px 0 0;> ul{list-style-type:none;margin:0;padding:0;> li{padding:10px 20px;background-color:#f1f1f166;border:1px solid #c7c0c096;&:hover{background-color:#cacaca96;cursor:pointer;}&:not(:first-child){border-top:0;}}}"]);
...
function (_Component) {
  ...
  _createClass(ReactSearchBox, [{
    ...
    value: function render() {
      return React__default.createElement(StyledContainer, null, React__default.createElement(GlobalStyle$1, null), this.inputNode(), this.dropdownNode());
    }
  }]);
